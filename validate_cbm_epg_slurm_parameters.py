...
from utils.argparser import (
    cbm_epg_argument_config,
    cbm_epg_argument_parser,
    cbm_epg_argument_validator,
)

if len(sys.argv) < 3:
    print("Invoke with python 'python validate_cbm_epg_slurm_parameters.py <start_id> <end_id>'")
    exit()
...
for slurm_id in range(start_id, end_id+1):
    try:
        ...
        cmd = cbm_epg_argument_config(slurm_id)[3:]
        args = parser.parse_args(cmd)

        cbm_epg_argument_validator(args)
